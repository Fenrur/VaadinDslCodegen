 ...
 * 1. Generate a factory class with CDI scope annotations
 * 2. Generate a DSL extension function for [com.vaadin.flow.component.HasComponents]
 *
 * Constructor parameters:
 * - Parameters without [GenDslParam] are treated as CDI-injected dependencies
 ...
 * @GenDsl
 * class CustomButton(
 *     private val logger: Logger,           // CDI-injected
